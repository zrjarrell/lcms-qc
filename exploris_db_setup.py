...
def make_db_tables(con, cur):
    ...
    cur.execute("CREATE TABLE experimentQC(experimentID TINYTEXT NOT NULL, qstd_num SMALLINT NOT NULL, mode TINYTEXT NOT NULL, num_peaks MEDIUMINT NOT NULL, num_peaks_2_reps MEDIUMINT NOT NULL, num_peaks_3_reps MEDIUMINT NOT NULL, pairwiseR_1 REAL NOT NULL, pairwiseR_2 REAL NOT NULL, pairwiseR_3 REAL NOT NULL, featureCV_q0 REAL NOT NULL, featureCV_q1 REAL NOT NULL, featureCV_q2 REAL NOT NULL, featureCV_q3 REAL NOT NULL, featureCV_q4 REAL NOT NULL, eic_path TINYTEXT NOT NULL, CONSTRAINT exp_qstd_mode PRIMARY KEY (experimentID, qstd_num, mode))")
    cur.execute("CREATE TABLE sampleQC(id TINYTEXT PRIMARY KEY, experimentID TINYTEXT NOT NULL, file_name TINYTEXT NOT NULL, sample_type TINYTEXT NOT NULL, mode TINYTEXT NOT NULL, scans SMALLINT NOT NULL, tic REAL NOT NULL, create_time REAL NOT NULL)")
    cur.execute("CREATE TABLE intStdTargets(id TINYTEXT PRIMARY KEY, chemical_name TINYTEXT NOT NULL, mode TINYTEXT NOT NULL, ref_mz REAL NOT NULL, ref_time REAL NOT NULL, adduct TINYTEXT NOT NULL)")
    cur.execute("CREATE TABLE posCtrlTargets(id TINYTEXT PRIMARY KEY, chemical_name TINYTEXT NOT NULL, mode TINYTEXT NOT NULL, ref_mz REAL NOT NULL, ref_time REAL NOT NULL, adduct TINYTEXT NOT NULL)")
